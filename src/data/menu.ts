...
export const menu: MenuCategory[] = [
  {
    ...
    items: [
      ...
      { id: "carne-porcion", name: "Carne", prices: [{ amount: 30000 }], video: "/videos/carne-cerdo.mp4" },
      { id: "choriza-porcion", name: "Choriza", prices: [{ amount: 31000 }], image: "/images/choriza-sandona.jpg" },
      { id: "chuleta-porcion", name: "Chuleta", prices: [{ amount: 32000 }], image: "/images/chuleta-valluna.jpg" },
