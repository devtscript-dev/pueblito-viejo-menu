...
export const menu: MenuCategory[] = [
  {
    ...
    items: [
      {
        id: "costilla-porcion",
        name: { es: "Costilla", en: "Ribs" },
        description: {
          es: "Costilla de cerdo asada al carbón, jugosa y con el toque ahumado de la casa.",
          en: "Charcoal-grilled pork ribs, juicy with our signature smoky touch.",
        },
        prices: [{ amount: 35000 }],
      ...
      },
      {
        ...
        prices: [{ amount: 31000 }],
        image: "/images/choriza-sandona.jpg",
      },
      {
        id: "chuleta-porcion",
        ...
        prices: [{ amount: 32000 }],
        image: "/images/chuleta-valluna.jpg",
      },
      {
  ...
  },
  {
    ...
    items: [
      {
        id: "micheladas",
        name: { es: "Micheladas", en: "Micheladas" },
        description: {
    ...
    items: [
      {
        ...
        description: {
          es: "Acompañado con arroz, patacón, ensalada, jugo del día, postre y aguacate.",
          en: "Served with rice, patacón, salad, juice of the day, dessert and avocado.",
        },
        prices: [{ amount: 60000 }],
      },
      {
      ...
      },
      {
        ...
        description: {
          es: "Acompañado con arroz, patacón, ensalada, jugo del día, postre, aguacate y crema de mariscos.",
          en: "Served with rice, patacón, salad, juice of the day, dessert, avocado and seafood cream sauce.",
        },
        prices: [{ amount: 72000 }],
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        description: {
          es: "Arroz, tajada de maduro, papa, ensalada, frijol, 1/4 de gallina.",
          en: "Rice, sweet plantain, potato, salad, beans, 1/4 hen.",
        },
        prices: [{ amount: 32000 }],
      ...
      },
      {
        ...
        name: { es: "Costilla", en: "Ribs" },
        description: {
          es: "Arroz, tajada de maduro, papa, ensalada, frijol, 170 grs. de costilla.",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        name: { es: "Gallina", en: "Hen" },
        description: {
          es: "Sopa, arroz, tajada de maduro, papa, ensalada, frijol, 1/4 de gallina, jugo y postre.",
          en: "Soup, rice, sweet plantain, potato, salad, beans, 1/4 hen, juice and dessert.",
        },
        prices: [{ amount: 37000 }],
        video: "/videos/gallina.mp4",
      },
      {
        ...
        name: { es: "Costilla", en: "Ribs" },
        description: {
          es: "Sopa, arroz, tajada de maduro, papa, ensalada, frijol, 170 grs. de costilla, jugo y postre.",
